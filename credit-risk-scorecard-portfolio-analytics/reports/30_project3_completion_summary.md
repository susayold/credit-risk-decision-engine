...
- Severe scenario stressed EL: 3,815,530,564
- Severe scenario stressed EAD: 20,388,583,399
- Severe stressed EL rate: 18.71%

## Pricing Result

- Lowest required rate by grade: 12.55%
- Highest required rate by grade: 28.13%

## Controls

- Formula tests passed: 15 / 15
- Acceptance criteria completed or documented with limitation: 23 / 23
